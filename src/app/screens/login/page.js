    ...
    <div className={styles.wrapper}>
      <div className={styles.leftside}>
        <div className={styles.leftsidecontent}>
          <div className={styles.leftlanguagebox}>
          ...
          <span className={styles.pleaseenter}>
            {isEnglish
              ? translation.en.Provide_your_login_details_to_continue
              : translation.mg.Provide_your_login_details_to_continue}
          </span>
          ...
          <div className={styles.inputfields}>
            <span>
              {isEnglish ? translation.en.Password : translation.mg.Password}
            </span>
            <div className={styles.inputwrapper}>
